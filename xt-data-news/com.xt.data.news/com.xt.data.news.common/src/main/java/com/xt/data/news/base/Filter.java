...
public class Filter implements Serializable {
	...
	public static Filter notIn(String property, Object value) {
		return new Filter(property, Filter.Operator.NOT_IN, value);
	}
	...
	public static Filter or(Filter... filters) {
		...
		return new Filter(null, Filter.Operator.OR, filterList);
	}
	 ...
	 * @return
	 */
	public static Filter join(String property, Object value) {
		return new Filter(property, Filter.Operator.JOIN, value);
	}
