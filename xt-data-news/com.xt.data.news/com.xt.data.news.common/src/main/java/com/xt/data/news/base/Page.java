...
public class Page<T> implements Serializable {
	 ...
	 * 内容
	 */
    @JsonView(BaseEntity.RequiredView.class)
	...
	public Page<T> addExtDate(String key, Object value) {
		if(getExtData()==null) {
			setExtData(new HashMap(6));
		}
		getExtData().put(key, value);
		return this;
	}
	
	public Page<T> removeExtDate(String key) {
		if(getExtData()==null) {
			return this;
		}
		getExtData().remove(key);
		return this;
	}
